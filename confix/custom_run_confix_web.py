...
# python3 ./confix/run_confix_web.py -h testing2 -i app/src/main,app/build/classes/java,gradleTest.Increment.AppTest,app/build/classes/java/main:app/build/classes/java/test,app/build/classes/java/main,gradle
def main(argv):
    try:
    ...
    ### for non-D4J projects
        ...
        if buildTool == "gradle" or buildTool == "Gradle":
            os.system("cd "+target_dir+" ; "
                    + "/home/codemodel/hans/paths/gradle-7.3/bin/gradle build")
            # print("are you in?")
