...
def main(argv):
    ...
    os.system("cd /home/goodtaeeun/ ; "
            + "git diff /home/goodtaeeun/APR_Projects/APR/target/"+target_project+"/patches/0/"+perfect_faulty_path
                    + " /home/goodtaeeun/APR_Projects/APR/target/"+target_project+ "/" + perfect_faulty_path
                    + " > /home/goodtaeeun/APR_Projects/APR/target/diff_file.txt")

    # # 패치의 path
    # /home/goodtaeeun/APR_Projects/APR/target/Math/patches/0/org/apache/commons/math/stat/Frequency.java
