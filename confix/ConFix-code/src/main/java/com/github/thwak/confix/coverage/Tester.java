...
public class Tester {
	...
	public void runSampleTestsWithJacoco(String classPath, String className, String sampleFileName, String jacocoPath,
	...
	public TestResult runTestsWithJUnitCore(List<String> testClasses, String classPath)
	...
	public TestResult runTest(String testClassName, String classPath) throws ClassNotFoundException, IOException {
		...
		for (String failedTest : result.failedTests) {
			if (failedTest.trim().contains("#warning") || failedTest.trim().contains("#initializationError")) {
				result.failCnt--;
			}
		}
