...
def main(argv):
    ...
    os.system("python3 ./pool/simfin/gv_ae_web.py -p test -k 10") # -p means predict, -t means train; -k is for top-k neighbors
    os.system("python3 ./pool/runner_web/prepare_pool_source_web.py")

    os.system("python3 ./confix/run_confix_web.py -d true")
