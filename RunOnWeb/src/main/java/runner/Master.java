...
// run commit collector
        ...
        list.add("python3");
		list.add("/home/goodtaeeun/APR_Projects/APR/pool/runner_web/commit_collector_web.py");
		list.add("-i");
...
// run change vector collector
		list.clear();
		list.add("python3");
		list.add("/home/goodtaeeun/APR_Projects/APR/pool/runner_web/change_vector_collector_web.py");
		if(is_d4j == true){
			list.add("-d");
			list.add("true");
		}
...
// run simfin
		list.clear();
        list.add("python3");
		list.add("/home/goodtaeeun/APR_Projects/APR/pool/simfin/gv_ae_web.py");
		list.add("-p");
		list.add("test");
		list.add("-k");
...
// run prepare pool source 
		list.clear();
        list.add("python3");
		list.add("/home/goodtaeeun/APR_Projects/APR/pool/runner_web/prepare_pool_source_web.py");
...
// run confix
		list.clear();
        list.add("python3");
		list.add("/home/goodtaeeun/APR_Projects/APR/confix/run_confix_web.py");
		if(is_d4j == true){
			list.add("-d");
			list.add("true");
		}
